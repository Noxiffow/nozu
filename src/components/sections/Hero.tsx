      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-16 items-center w-full">
        ...
        <div>
          ...
          <motion.h1
            ...
            style={{
              background:
                "linear-gradient(140deg, #ffffff 0%, #e8e3dc 50%, #f97316 100%)",
          ...
          >
            <a
              href="#contacto"
              className="px-6 py-3 rounded-xl font-semibold text-sm bg-[#f97316] text-white
            ...
            <a
              href="#proyectos"
              className="px-6 py-3 rounded-xl font-semibold text-sm border border-white/[0.1]
      ...
      <div className="absolute bottom-0 left-0 right-0 border-t border-white/[0.05] overflow-hidden py-3">
        ...
        >
          {techStack.map((tech, i) => (
            <span
              key={i}
              className="text-xs font-mono text-[#6b6560] hover:text-[#f97316] transition-colors cursor-default"
            >
              {tech}
            </span>
          ))}
