              ...
              <ShiftCard
                ...
                topContent={
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <span
                      className={`shrink-0 text-[10px] font-mono px-2 py-0.5 rounded-full border ${project.statusColor}`}
                    >
                      {project.status}
                    </span>
                  </div>
                      ...
                      {project.tags.map((tag) => (
                        <span
                          ...
                          className="px-2 py-0.5 rounded-md text-[10px] font-mono
                            bg-white/[0.04] text-[#6b6560] border border-white/[0.06]"
                        >
                          {tag}
                        </span>
                      ))}
                ...
                bottomContent={
                  <div className="flex items-center gap-3">
                    <a
                      ...
                      className="flex items-center gap-1.5 text-xs text-[#a09890] hover:text-white transition-colors"
                    >
                      <svg
                        width="14"
                        height="14"
                    ...
                    {project.demo && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-1.5 text-xs text-[#f97316] hover:text-[#fb923c] transition-colors font-medium"
                      >
                        <svg
                          width="12"
                          height="12"
