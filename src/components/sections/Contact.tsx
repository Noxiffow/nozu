  ...
  return (
    ...
    >
      <div className="max-w-2xl mx-auto text-center">
        ...
        >
          <a
            href="https://wa.me/34604923459?text=Hola%20Jonathan%2C%20me%20interesa%20hablar%20sobre%20un%20proyecto"
            target="_blank"
            rel="noopener noreferrer"
            className="px-8 py-3.5 rounded-xl font-semibold text-sm bg-[#25d366] text-white
              hover:bg-[#1ebe5c] transition-all duration-200
              shadow-[0_8px_28px_rgba(37,211,102,0.35)] hover:shadow-[0_8px_32px_rgba(37,211,102,0.5)]
              hover:-translate-y-0.5 active:translate-y-0 flex items-center gap-2 justify-center"
          >
